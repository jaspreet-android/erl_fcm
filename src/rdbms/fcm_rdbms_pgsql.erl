-module(fcm_rdbms_pgsql).
-author("jaspreet.android@gmail.com").
-behaviour(fcm_rdbms_backend).
...
db_opts(Options) ->
    ...
    maps:merge(BasicOpts#{codecs => [{fcm_rdbms_pgsql_codec_boolean, []}]}, TLSOpts).
...
-spec pgsql_to_rdbms(epgsql:reply(term())) -> fcm_rdbms:query_result().
